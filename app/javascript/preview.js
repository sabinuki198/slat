document.addEventListener('DOMContentLoaded', function(){
  ...
  const buildNewFileField = () => {
    ...
    newFileField.setAttribute('name', 'content[images][]');

    // 最後のfile_fieldを取得
    const lastFileField = document.querySelector('input[type="file"][name="content[images][]"]:last-child');
  ...
  // 指定したdate-indexを持つプレビューとfile_fieldを削除する
  ...
  // input要素を取得
  const fileField = document.querySelector('input[type="file"][name="content[images][]"]');
